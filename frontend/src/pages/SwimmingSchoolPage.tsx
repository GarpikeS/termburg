...
import { Waves, GraduationCap, Clock, Users, CheckCircle, ChevronRight, X } from 'lucide-react';
...
const advantages = [
  ...
  'Группы до 6 человек — индивидуальный подход',
  'Сертифицированные тренеры с опытом от 5 лет',
  'Занятия для детей от 4 лет и взрослых',
  'Удобное расписание: будни и выходные',
...
export default function SwimmingSchoolPage() {
  ...
  return (
    <PageLayout title="Школа плавания" description="Обучение плаванию для детей и взрослых в термальном бассейне Термбурга.">
      <PageHero
        title="Школа плавания"
        subtitle="Обучение плаванию для детей и взрослых в тёплом термальном бассейне"
        backgroundImage="/images/complex/pool.webp"
      />
        ...
        <div className="mx-auto max-w-4xl flex flex-col-reverse md:flex-row items-center gap-8">
          <div className="flex-1 space-y-4">
            ...
            <p className="text-lg leading-relaxed text-text-secondary">
              Наша школа плавания работает в тёплом термальном бассейне — комфортная температура воды круглый год.
              Занятия проводят сертифицированные тренеры с индивидуальным подходом к каждому ученику.
            </p>
            <p className="text-lg leading-relaxed text-text-secondary">
              Принимаем детей от 4 лет и взрослых любого уровня подготовки — от первого знакомства с водой до совершенствования техники.
            </p>
          </div>
          <img src="/images/complex/pool.webp" alt="Бассейн Термбурга" className="w-full md:w-72 h-48 md:h-56 rounded-2xl object-cover flex-shrink-0" />
        </div>
      </Section>
      ...
      <section className="relative bg-dark-surface ornament-pattern py-16 text-center">
        ...
        <Container>
          ...
          <h2 className="mb-4 font-heading text-2xl font-bold text-white md:text-3xl">Запишитесь на пробное занятие</h2>
          <p className="mx-auto mb-8 max-w-xl text-white/70">Первое занятие — бесплатно. Познакомьтесь с тренером и бассейном.</p>
